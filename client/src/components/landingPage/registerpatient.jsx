              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white bg-opacity-40 outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <form onSubmit={()=> register()} className="bg-gray-200 bg-opacity-80 shadow-md rounded px-8 pt-6 pb-8 w-full">
                    ...
                    <input type="email" required className="shadow appearance-none border rounded w-full py-2 px-1 text-black" onChange={(e) => {setEmail(e.target.value)}}/>
                    <label className="block text-black text-sm font-bold mb-1">
                      Sex
                    </label>
                    <input type="text" required className="shadow appearance-none border rounded w-full py-2 px-1 text-black" onChange={(e) => {setSex(e.target.value)}}/>
                    <label  className="block text-black text-sm font-bold mb-1">
                      Age
                    </label>
                    ...
                    <input type="password" required className="shadow appearance-none border rounded w-full py-2 px-1 text-black" onChange={(e) => {setPassword(e.target.value)}}/>
                    <label className="block text-black text-sm font-bold mb-1">
                      Medical History
                    </label>
                    <input type="text" required className="shadow appearance-none border rounded w-full py-2 px-1 text-black" onChange={(e) => {setHistory(e.target.value)}}/>
